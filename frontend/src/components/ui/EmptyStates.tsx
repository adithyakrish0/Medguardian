...
import { Pill, Users, Bell, FileText, CheckCircle, Calendar, Activity, PartyPopper } from 'lucide-react';
        ...
        <EmptyStateBase
            ...
            title={
                <span className="flex items-center justify-center gap-2">
                    All Caught Up! <PartyPopper className="w-5 h-5 text-yellow-500" />
                </span>
            }
