...
def generate_pdf():
    ...
    try:
        ...
        # Title
        elements.append(Paragraph("💊 My Medication Schedule", title_style))
        ...
        for med in medications:
            if med.morning:
                schedule['🌅 Morning (8:00 AM)'].append(med)
            if med.afternoon:
                schedule['☀️ Afternoon (12:00 PM)'].append(med)
            if med.evening:
                schedule['🌆 Evening (6:00 PM)'].append(med)
            if med.night:
                schedule['🌙 Night (9:00 PM)'].append(med)
        ...
        elements.append(Paragraph("📌 Stick this on your refrigerator or keep it by your bedside", footer_style))
...
def medical_card():
    ...
    try:
        ...
        elements.append(Paragraph("🏥 Medical ID Card", title_style))
        ...
        for med in medications:
            elements.append(Paragraph(f"• {med.name} - {med.dosage}", styles['Normal']))
